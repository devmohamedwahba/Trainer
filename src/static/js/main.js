...
$(".send-button").on("click", function(event) {
    ...
    let undesirable_area = $('#undesirableArea').val();
...
if (chronic_diseases == null ||
    ...
    daily_Activity == null || go_gym == null || When_train == null ||
     nutrition_area == null || undesirable_area == null || workout_area == null || online_training_area == null ||
      name == ""){
 ...
 $('.submit-btn').on("click", function(event){
    ...
    undesirable_area:undesirable_area,
